            ...
            <div class="content_page_flex">
                <div class="content_page services">
                    <div class="article_full">
                        ...
                        <h1>Загрузите Свидетельство о регистрации ТС:</h1>
                        <img   style="max-height: 430px; max-width: 100%; align-items: center; border-radius: 5px; "  src="{{asset('images')}}/sts.jpg">
                        <?php
                        if(count($errors)>0){
                            $icon = 'err.png';
                        }else{
                        ...
                        <form class="tools osago" method="post" action="/upload2" enctype="multipart/form-data" id="my-form">
