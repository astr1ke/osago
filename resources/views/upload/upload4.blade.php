...
@section('content')
    <main class="main page">
        <div class="page_wrapper">
            <p id="breadcrumbs">
                <span typeof="v:Breadcrumb"><a href="/" rel="v:url" property="v:title">Главная страница</a> / <span class="breadcrumb_last">Документы загружены!</span></span>
            </p>
            ...
            <div class="content_page_flex">
                <div class="content_page services">
                    <div class="article_full">
                        ...
                        <h1>Все документы загружены!!!</h1>


                        <img   style="max-height: 350px; align-items: center; border-radius: 5px; max-width: 100%"  src="{{asset('images')}}/osago.jpg">
                        ...
                        <div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-small moto-spacing-left-auto" data-widget="text" data-preset="default" data-spacing="aasa">
                            <div class="moto-widget-text-content moto-widget-text-editable">
                                <p class="moto-text_system_7" style="margin-top: 30px; max-width: 750px">
                                    Осталось ввести только номер для связи, после того как мы расчитаем стоимость, мы вам перезвоним!
                                </p>
                            </div>
                        </div>
                        ...
                        <form class="tools osago" method="post" action="/upload4" enctype="multipart/form-data" id="my-form">

                            @csrf

                            <input type="text" name="number" placeholder="Номер телефона для связи..." style="max-width: 300px; margin-right: 30px; margin-bottom: 30px"/>

                            <input type="text" name="comment" placeholder="Так же можете оставить коментарий" style="max-width: 415px; margin-bottom: 10px"/>

                            <br>
                            <label>Для вновь купленных автомобилей необходимы дополнительные документы:</label>
                            <input type="text" name="more" id="more" hidden>
                            <button type="submit" class="g-recaptcha b_osago" style="max-width: 750px; background: #5b7eb8; margin-bottom: 10px; margin-top: 5px " onclick="document.getElementById('more').value = '1'">Доп. документы</button>

                            <button type="submit" class="g-recaptcha b_osago" style="max-width: 750px; background: #d22f2f; margin-top: 10px ">Сохранить и вернуться</button>
