...
<main class="main page">
    <div class="page_wrapper">
        <p id="breadcrumbs">
            <span typeof="v:Breadcrumb"><a href="/" rel="v:url" property="v:title">Главная страница</a> / <span class="breadcrumb_last">Загрузка водительских удостоверений</span></span>
        </p>
        ...
        <div class="content_page_flex">
            <div class="content_page services">
                <div class="article_full">
                    ...
                    <h1>Загрузите Водительские удостоверения:</h1>
                    <img   style="max-height: 477px; align-items: center; border-radius: 5px; max-width: 100%"  src="{{asset('images')}}/prava.jpg">
                    ...
                    <form class="tools osago" method="post" action="/upload3" enctype="multipart/form-data" id="my-form">
                        ...
                        <button class="g-recaptcha b_osago" onclick="document.getElementById('upload_hidden1').click(); return false" style="max-width: 250px; margin-bottom: 0px; margin-right: 10px">Главная страница</button>
                        <img src="{{asset('images')}}/wait.png" id="upload_visible1" style="display: initial; height: 30px; width: 30px; margin-right: 5px">
                        <img src="{{asset('images')}}/done.png" id="upload_visible11" style="display: none; height: 30px; width: 30px; margin-right: 5px">

                        <button class="g-recaptcha b_osago" onclick="document.getElementById('upload_hidden2').click(); return false" style="max-width: 250px; margin-top: 10px; margin-right: 10px">Обратная сторона</button>
                        <img src="{{asset('images')}}/wait.png" id="upload_visible2" style="display: initial; height: 30px; width: 30px">
                        <img src="{{asset('images')}}/done.png" id="upload_visible22" style="display: none; height: 30px; width: 30px">

                        <input type="text" name="more" id="more" hidden>

                        <button type="submit" class="g-recaptcha b_osago" style="max-width: 615px; background: #5b7eb8; margin-bottom: 10px " onclick="document.getElementById('more').value = '1'">Добавить еще водителя</button>
                        <button type="submit" class="g-recaptcha b_osago" style="max-width: 615px; background: #d22f2f; margin-top: 0px ">Закончить отправку</button>
